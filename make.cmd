...
rem even if started from cmd.exe or PowerShell. Having both `make.bat`
rem and `make.cmd` means cmd.exe and PowerShell will resolve `make`
rem without needing the explicit extension.
rem Usage:
