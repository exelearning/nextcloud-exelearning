/**
 * MIME detection for the assets we serve out of an `.elpx` package. Kept as a
 * pure map so it can be reused by the Service Worker (no DOM there) and by
 * the in-page iframe renderer.
 */
